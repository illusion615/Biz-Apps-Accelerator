...
未来基于此架构可以进行扩展来增加通知以及供外部系统调用的WebAPI接口，类似于下图。

> 由于通知、微服务架构取决于企业IT规划策略，因此在本加速其中并不包含。后续可能会针对一些公共服务提供单独的加速器参考。

![1652060070892.png](image/README/1652060070892.png)

## 数据模型

![1652060834538.png](image/README/1652060834538.png)
